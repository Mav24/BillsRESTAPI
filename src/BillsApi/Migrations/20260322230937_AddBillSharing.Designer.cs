...
namespace BillsApi.Migrations
{
    ...
    [Migration("20260322230937_AddBillSharing")]
    partial class AddBillSharing
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BillsApi.Models.BillShare", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("BillId", "SharedWithUserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("BillsApi.Models.BillShare", b =>
                {
                    b.HasOne("BillsApi.Models.Bill", "Bill")
                        .WithMany("Shares")
                        .HasForeignKey("BillId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BillsApi.Models.User", "SharedByUser")
                        .WithMany()
                        .HasForeignKey("SharedByUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("BillsApi.Models.User", "SharedWithUser")
                        .WithMany()
